...
## Development environment and release process
 ...
 - create virtualenv with Flask and MidRusNLP installed into it (latter is installed in
...
install it (`pip install hseling_api_midrusnlp.tar.gz`), ensure that configuration file exists and
`HSELING_API_MIDRUSNLP_SETTINGS` environment variable points to it, ensure that user has access to the
